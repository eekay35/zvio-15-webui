...
@Component({
  selector: 'app-zv-support',
//   template: '<entity-form [conf]="this"></entity-form>',
  templateUrl: './zv-support.component.html'
})
export class ZvSupportComponent implements OnDestroy {
  ...
  fieldSets: FieldSet[] = [
    {
        name: 'column1',
        width: '100%',
        label: false,  //'Please visit the <a href="https://github.com/zvaultio/Community">zvaultio community page</a> for support'
        config: [
            {
                type: 'paragraph',
                name: 'supportlink',
                paraText: 'Please visit the <a href="https://github.com/zvaultio/Community">zvaultio community page</a> for support'
            }
        ]
    },
    // {
